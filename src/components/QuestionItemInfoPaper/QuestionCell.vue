<template>
  <view class="questionItemInfoPaper">
    <view v-if="level === 1 || quesStructPm != '23'">
      ...
      <view class="ques-option-paper" v-if="vdata.rule.o && checkStem && getOptions(ques)">
        <view v-for="(suboption, index) in getOptions(ques)" :key="index" class="answer-item">
